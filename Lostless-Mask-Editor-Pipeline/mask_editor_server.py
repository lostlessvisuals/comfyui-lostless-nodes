...
@PromptServer.instance.routes.post("/mask_editor/launch")
async def launch_mask_editor(request):
    ...
    try:
        ...
        temp_dir = tempfile.mkdtemp(prefix="mask_editor_")
        ...
        if session_output_dir and os.path.exists(session_output_dir):
            ...
            sessions_dir = os.path.join(tempfile.gettempdir(), "mask_editor_sessions")
